                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="return_books.php"><i class="fa fa-meh-o"></i>Return Books<span class="fa fa-chevron-down"></span></a>

                            </li>
                            <li><a href="books_details_with_student.php"><i class="fa fa-bar-chart-o"></i> Books With All Details<span
                                    class="fa fa-chevron-down"></span></a>
